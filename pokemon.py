#Isla Hudecek
#Coding a pokemon game (pokemon 43-45)
...
def train():
    ...
    global level
    print (f'day{day}')
    print (f'You pokemon is working on attack, they gained 1 level')
    level=level + 1
    day = day+1
    return {level}
def battles():
...
def main():
    ...
    global train
    global day
    print('Welcom to Pokemon in this game you will need to train your pokemon in order for him to evolve!')
    print ('You have one action a day so dont waist it!!!')
    for i in range(10):
